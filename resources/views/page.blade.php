...
<body class="overflow-x-hidden">
        ...
        <div class="flex items-center justify-between py-4 px-6">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-[#E1F0E8] divide-y divide-gray-200 rounded-lg shadow-lg" id="user-dropdown">
                    <div class="px-4 py-3">
                        <!-- User information -->
                        <span class="block text-sm text-[#3F4B3B] font-semibold">John Doe</span>
                        <span class="block text-sm text-[#3F4B3B] truncate">john.doe@example.com</span>
                    </div>
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <!-- Settings link -->
                        <li >
                            <a href="#" class="flex items-center px-4 py-2 text-sm text-[#3F4B3B] hover:bg-[#7A9E7E] hover:text-[#00171F] rounded transition duration-200">
    ...
    <footer class="footer bg-white rounded-lg shadow m-4 dark:bg-[#B3EFB2]">
        <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-center">
            <span class="text-sm text-[#06070E] text-center dark:text-[#06070E]">© 2024 <a href="#" class="hover:underline">NoteGuard™</a>. All Rights Reserved. Event-Prime</span>
